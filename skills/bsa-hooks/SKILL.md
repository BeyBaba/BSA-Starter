...
1. `grep -i 'hook' C:/Users/BSA/Projects/BigBrain/lessons/INDEX.md` → ilgili dersleri (L-0026, L-0049, L-0050, L-0062, L-0063, L-0065, L-0083, L-0097) "Uygulanan dersler" olarak not al.
...
- **L-0026** — SessionStart `additionalContext` ~2KB'de sessizce kesilir. Hook'ta `cat` ile dosya basma; `grep` ile başlık/tablo satırı çek, çıktıyı `| head -c 1800` ile sınırla, "detay gerekirse dosyayı oku" notu ekle.
